...
These libraries are automatically installed during the initial startup of Pimosa, ensuring a smooth experience for non-technical users. However, if you prefer manual installation, we've provided instructions below.
