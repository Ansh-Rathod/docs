...
<Steps>
  ...
  <Step title="Step 4: Add the paths to the app">
      Now,you can get the installation paths of the tools by running:
      ...
      You can copy and paste the output path of the each command in the text field of the Pimosa app and you're good to use the app.
...
Now that **FFmpeg**, **ImageMagick**, and **ExifTool** are installed, you're ready to start using Pimosa app!
