---
title: Installing Required Libraries Automatically
...
```bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ansh-Rathod/pimosa-builds/HEAD/maclibsinstall.sh)"
```
